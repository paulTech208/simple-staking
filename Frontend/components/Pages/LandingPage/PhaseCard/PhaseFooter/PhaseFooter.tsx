...
const PhaseFooter = () => (
  <div className="flex flex-col mt-6">
    <div className="w-full flex justify-center gap-[30px]">
      <Link href="/howtobuy">
        <div className="cursor-pointer text-green font-poppins_medium text-[10px]">
          How to stake?
        </div>
      </Link>
      <Link href="/help">
        <div className="cursor-pointer text-green font-poppins_medium text-[10px]">Get Help</div>
      </Link>
      <Link href="/exchange">
        <div className="cursor-pointer text-green font-poppins_medium text-[10px]">
          Exchange tokens
